...
def interpolation(trial):
    interpolation = KNeighborsRegressor(trial.suggest_int("interpolation_neighbours", low=3, high=20, eights="distance"))
...
if __name__ == '__main__':    
    ...
    model_data_all =  ModelData(training_file='../chembl231_pki_fps_ds_train.txt', # position of data points in feature space
                        response_file='../chembl231_plo_response_train.txt') # corresponding response values
