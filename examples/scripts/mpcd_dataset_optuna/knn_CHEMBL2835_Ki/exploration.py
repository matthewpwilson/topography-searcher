...
if __name__ == '__main__':    
    ...
    model_data_all =  ModelData(training_file='../CHEMBL2838_KI_fps_ds_train.txt', # position of data points in feature space
                        response_file='../CHEMBL2838_KI_response_train.txt') # corresponding response values
