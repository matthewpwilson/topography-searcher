...
if __name__ == '__main__':    
    ...
    model_data_all =  ModelData(training_file='../CHEMBL4203_KI_fps_ds_train.txt', # position of data points in feature space
                        response_file='../CHEMBL4203_KI_response_train.txt') # corresponding response values
